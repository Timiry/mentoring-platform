    ...
    <AppBar position="fixed" sx={{ backgroundColor: "#FFFFFF" }}>
      <Toolbar>
        <Box sx={{ flexGrow: 1 }}>
          <Link
            href="/"
            sx={{ textDecoration: "none", color: "button.primary" }}
          >
        ...
        new Date(localStorage.refreshTokenExpiry) > new Date() ? (
          <Box>
            ...
            <Button sx={{ color: "button.primary" }} href="/messenger">
              Мессенджер
            </Button>
            <Button sx={{ color: "button.primary" }} href="/profile">
              Профиль
            </Button>
            <Button sx={{ color: "button.primary" }} href="/logout">
              Выйти
            </Button>
          </Box>
        ) : (
